...
import { html } from "https://cdn.jsdelivr.net/npm/@codemirror/lang-html@0.19.4/dist/index.min.js";
import { css } from "https://cdn.jsdelivr.net/npm/@codemirror/lang-css@0.19.1/dist/index.min.js";
import { javascript } from "https://cdn.jsdelivr.net/npm/@codemirror/lang-javascript@0.19.5/dist/index.min.js";

let currentLanguage = html(); // Default to HTML

let editor = new EditorView({
  doc: "<!-- Start typing your HTML here -->",
  extensions: [basicSetup, currentLanguage],
  parent: document.getElementById("editorContainer")
});

// Change language dynamically
document.getElementById("editorSelect").addEventListener("change", (e) => {
  const lang = e.target.value;
  let newLang;
  if (lang === "html") newLang = html();
  if (lang === "css") newLang = css();
  if (lang === "js") newLang = javascript();

  editor.dispatch({
    effects: EditorView.reconfigure.of([basicSetup, newLang])
  });
});
